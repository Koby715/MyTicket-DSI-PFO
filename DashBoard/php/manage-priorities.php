 ...
 * Gestion des priorités du référentiel
 */
...
try {
    $stmt = $pdo->query("SELECT * FROM priorities ORDER BY level ASC");
...
<html lang="fr">
<head>
    <title>Gérer les Priorités - PFO DSI</title>
    <meta charset="utf-8">
...
<body data-pc-preset="preset-1" data-pc-direction="ltr" data-pc-theme="light">
                ...
                <ul class="pc-navbar mt-2">
                    ...
                    <li class="pc-item pc-hasmenu">
                        ...
                        <ul class="pc-submenu">
                            ...
                            <li class="pc-item active"><a class="pc-link" href="manage-priorities.php">Priorités</a></li>
                    ...
                    <div class="row align-items-center">
                        <div class="col-md-12">
                            <div class="page-header-title">
                                <h2 class="m-b-10" style="font-weight: 800; color: #1e293b;">Gestion des <span class="text-primary">Priorités</span></h2>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="table-responsive">
                                <table class="table table-hover align-middle mb-0">
                                    <thead class="bg-light">
                                        <tr>
                                            <th class="ps-4" style="width: 80px;">NIVEAU</th>
                                        ...
                                        <?php if (empty($priorities)): ?>
                                            <tr>
                                                <td colspan="4" class="text-center py-5">
                                                    <i class="ti ti-alert-circle f-40 text-muted mb-3 d-block"></i>
                                                    <p class="text-muted">Aucune priorité trouvée.</p>
                                                </td>
                                            </tr>
                                        <?php else: ?>
                                            <?php $i = 1; foreach ($priorities as $prio): ?>
                                                <tr>
                                                    <td class="ps-4">
                                                        <span class="badge-level"><?= $prio['level'] ?></span>
                                                    </td>
                                                    <td><span class="fw-700 text-dark"><?= htmlspecialchars($prio['name']) ?></span></td>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content border-0 shadow-lg" style="border-radius: 20px;">
                <div class="modal-header border-0 pt-4 px-4">
                    <h5 class="modal-title fw-700">Nouvelle Priorité</h5>
                ...
                <form action="" method="POST">
                    ...
                    <div class="modal-body px-4">
                        <div class="mb-3">
                            <label class="form-label">Nom de la priorité</label>
                            <input type="text" name="name" class="form-control bg-light border-0" placeholder="ex: Urgent, Haute, Moyenne..." required>
                        </div>
                        <div class="mb-3">
                            <label class="form-label">Niveau (Ordre d'importance)</label>
                            <input type="number" name="level" class="form-control bg-light border-0" placeholder="0 = Maximum" value="1" required>
                            <small class="text-muted">Plus le niveau est bas, plus la priorité est haute dans les listes.</small>
                        </div>
                    </div>
    ...
    <div class="modal fade" id="editModal" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content border-0 shadow-lg" style="border-radius: 20px;">
                <div class="modal-header border-0 pt-4 px-4">
                    <h5 class="modal-title fw-700">Modifier la Priorité</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <form action="" method="POST">
                    ...
                    <div class="modal-body px-4">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" name="level" id="edit-level" class="form-control bg-light border-0" required>
                        </div>
                    </div>
                    <div class="modal-footer border-0 pb-4 px-4">
                        <button type="button" class="btn btn-light rounded-pill" data-bs-dismiss="modal">Annuler</button>
    ...
    <div class="modal fade" id="deleteModal" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content border-0 shadow-lg" style="border-radius: 20px;">
                <div class="modal-header border-0 pt-4 px-4">
                    <h5 class="modal-title fw-700 text-danger">Supprimer la Priorité</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <form action="" method="POST">
                    ...
                    <div class="modal-body px-4">
                        <p>Êtes-vous sûr de vouloir supprimer la priorité <b id="delete-name"></b> ? Cette action est irréversible.</p>
                    </div>
                    <div class="modal-footer border-0 pb-4 px-4">
                        <button type="button" class="btn btn-light rounded-pill" data-bs-dismiss="modal">Annuler</button>
