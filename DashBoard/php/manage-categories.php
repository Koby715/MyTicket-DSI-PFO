 ...
 * Gestion des catégories du référentiel
 */
...
<html lang="fr">
<head>
    <title>Gérer les Catégories - PFO DSI</title>
    <meta charset="utf-8">
...
<body data-pc-preset="preset-1" data-pc-direction="ltr" data-pc-theme="light">
            ...
            <div class="navbar-content">
                <ul class="pc-navbar mt-2">
                    ...
                    <li class="pc-item pc-hasmenu">
                        ...
                        <ul class="pc-submenu">
                            <li class="pc-item active"><a class="pc-link" href="manage-categories.php">Catégories</a></li>
                    ...
                    <div class="row align-items-center">
                        <div class="col-md-12">
                            <div class="page-header-title">
                                <h2 class="m-b-10" style="font-weight: 800; color: #1e293b;">Gestion des <span class="text-primary">Catégories</span></h2>
                            </div>
                        </div>
                    </div>
                </div>
                                        ...
                                        <?php if (empty($categories)): ?>
                                            <tr>
                                                <td colspan="3" class="text-center py-5">
                                                    <i class="ti ti-category f-40 text-muted mb-3 d-block"></i>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content border-0 shadow-lg" style="border-radius: 20px;">
                <div class="modal-header border-0 pt-4 px-4">
                    <h5 class="modal-title fw-700">Nouvelle Catégorie</h5>
                ...
                <form action="" method="POST">
                    ...
                    <div class="modal-body px-4">
                        <div class="mb-3">
                            ...
                            <input type="text" name="name" class="form-control bg-light border-0" placeholder="ex: Réseau, Logiciel..." required>
                        </div>
                    </div>
    ...
    <div class="modal fade" id="deleteModal" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content border-0 shadow-lg" style="border-radius: 20px;">
                <div class="modal-header border-0 pt-4 px-4">
                    <h5 class="modal-title fw-700 text-danger">Supprimer la Catégorie</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <form action="" method="POST">
                    ...
                    <div class="modal-body px-4">
                        <p>Êtes-vous sûr de vouloir supprimer la catégorie <b id="delete-name"></b> ? Cette action est irréversible.</p>
                    </div>
                    <div class="modal-footer border-0 pb-4 px-4">
                        <button type="button" class="btn btn-light rounded-pill" data-bs-dismiss="modal">Annuler</button>
                        <?php if (in_array($admin_role, ['ADMIN', 'SUPERVISOR'])): ?>
    ...
    <script>
        // Script pour remplir les modaux de modification et suppression
